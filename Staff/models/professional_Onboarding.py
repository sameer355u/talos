...
class MstHealthProfessional(models.Model):
    ...
    EmpPhoneNumber = models.CharField(max_length=13)
    ...
    @staticmethod
    def get_doctor(MstHealthProfessionalIDPK):
        return MstHealthProfessional.objects.get(MstHealthProfessionalIDPK=MstHealthProfessionalIDPK)

    @staticmethod
    def get_doctor_id(UserIDFK):
        return MstHealthProfessional.objects.get(UserIDFK=UserIDFK, ApprovalStatus='Approved')

    @staticmethod
    def get_doctors_list():
        return MstHealthProfessional.objects.all()
...
class HealthProfessionalPersonalDetails(models.Model):
    ...
    MstHealthProfessionalIDFK = models.ForeignKey(MstHealthProfessional, on_delete=models.RESTRICT,
                                                  default=MstHealthProfessional)
    EmpID = models.CharField(max_length=10, default='EMP')
